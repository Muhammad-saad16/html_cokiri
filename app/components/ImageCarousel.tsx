...
export default function ImageCarousel({
  ...
  return (
    <div
      role="region"
      aria-label="Campus and community photos"
          ...
          {Array.from({ length: pageCount }).map((_, pageIndex) => {
            ...
            return (
              <div
                ...
                className="flex w-full flex-shrink-0 gap-4 md:gap-6"
              >
                {pageSlides.map((slide, slideIndex) => {
                  const absoluteIndex = pageIndex * itemsPerView + slideIndex;
                  return (
                    <div
                      key={absoluteIndex}
                      style={{
                    ...
                    >
                      <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-research-grey shadow-[0_12px_28px_-14px_rgba(75,54,33,0.35)]">
                        <Image
                          src={slide.src}
                          alt={slide.alt}
                          fill
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-scholar-brown/80 via-scholar-brown/0 to-transparent" />
                        {slide.caption && (
                          <div className="absolute inset-x-0 bottom-0 p-4 md:p-5">
                            <p className="font-serif text-base font-semibold text-paper-white drop-shadow md:text-lg">
                              {slide.caption}
                            </p>
                          </div>
                        )}
